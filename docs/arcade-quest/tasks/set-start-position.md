...
![Scratch blocks setting the player's starting position and direction](../assets/scratchblocks/start-position-only.png){ .scratch-image }
...
![Example Scratch project at the end of Part 2](../assets/part-2-check.png){ .example-image }
