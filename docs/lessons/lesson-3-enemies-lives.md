...
2. Create a variable called `lives`. Choose **For all sprites**. Use the [variable instructions from Lesson 1](lesson-1-hero-controls.md#how-to-create-a-variable) if you need a reminder.
